...
class MedicineDatabase:
    ...
    def check_interactions(self, medicine: str, other_medicines: List[str] = None) -> Dict:
        """
        ...
        medicine_key = str(medicine).lower()
        ...
        if medicine_key in self.interactions:
            ...
            if other_medicines:
                for other_med in other_medicines:
                    other_med_str = str(other_med).lower()

                    if other_med_str in known_interactions:
